...
public class KeyboardSpawner: MonoBehaviour {
    ...
    protected virtual GameObject spawnObject() {
        ...
        GameObject newObject = Instantiate(prefabToSpawn, positionOfSpawnedObject, rotationOfSpawnedObject); //laser spawn
    ...
    private void Update() {
        if (Input.GetKeyDown(keyToPress) && Time.time > nextFire) {
